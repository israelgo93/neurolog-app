      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <label  htmlFor="search-name" className="text-sm font-medium mb-2 block">Niño</label>
            ...
            <div>
              <label  htmlFor="search-name" className="text-sm font-medium mb-2 block">Período</label>
              <DatePickerWithRange 
                date={dateRange}
