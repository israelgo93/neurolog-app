...
function ChildrenStats({ children }: Readonly<{ children: ChildWithRelation[] }>) {
  return (
...
export default function ChildrenPage() {
  ...
  const filteredChildren = useMemo(() => filterChildren(filters), [
    children,
    filters,
    filterChildren,
  ]);
