...
CREATE TABLE profiles (
  ...
  role user_role DEFAULT (SELECT VALUE FROM (VALUES ('parent')) AS v(VALUE)),
  avatar_url TEXT,
  phone TEXT,
...
CREATE TABLE daily_logs (
  ...
  intensity_level intensity_level_type DEFAULT (SELECT VALUE FROM (VALUES ('medium')) AS v(VALUE)),
